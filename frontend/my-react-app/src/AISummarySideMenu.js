...
const PrototypeSideMenu = ({ handleAISummarySheetSelection, sheetTitles, onSheetSelect, sheetData, xlsxTitle, dataStore, handleSelectedSheet, schemaConfigSelected }) => {
...
//depcerecated
  ...
  const handleSheetSelect = (index, sheetTitle) => {
   ...
   const handleAISummarySheetSelected = (index, structTitle) =>{
     console.log(structTitle)
     setSelectedSheet(structTitle);
     console.log(selectedSheet)
     handleAISummarySheetSelection(structTitle)
   }
       ...
       <div className='sidemenu-title'> </div>
        {dataStore.canvases ? dataStore.canvases.map((title, index) => (
          <li
             ...
             onClick={() => handleAISummarySheetSelected(index, title)}
           >
             {title}
           </li>
